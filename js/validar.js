document.addEventListener("DOMContentLoaded", function() {
    ...
    function validateName(e) {
        ...
        if (!e.target.value.trim().match(nameRegex)) {
            nameFeedback.textContent = "Nome Inválido!";
    ...
    function validateYear(e) {
        ...
        if (!e.target.value.trim().match(yearRegex)) {
            yearFeedback.textContent = "Ano Inválido!";
    ...
    function validateEmail(e) {
        ...
        if (!e.target.value.trim().match(emailRegex)) {
            emailFeedback.textContent = "Endereço de e-mail incorreto!";
    ...
    function validatePassword(e) {
        ...
        passwordStrengthMeter.value = passwordStrengthValue;
        updatePasswordStrengthVisuals(passwordStrengthMeter, passwordStrengthValue);
    ...
    function calculatePasswordStrength(password) {
        ...
        return { fraca: 10, moderada: 20, forte: 30 }[strengthLevel] || 0;
    }
  
    // Atualiza a cor do medidor de força da senha baseado no valor
    function updatePasswordStrengthVisuals(meter, value) {
        meter.style.backgroundColor = value >= 30 ? "#32CD32" : value >= 20 ? "#ffa500" : value >= 10 ? "#ff3e3e" : "#ccc";
    }
